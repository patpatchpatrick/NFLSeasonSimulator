...
public class SimulatorPresenter extends BasePresenter<SimulatorMvpContract.SimulatorView>
    ...
    public void loadCurrentSeasonMatches() {
        ...
        Week weekEleven = mModel.getSeasonSchedule().getWeek(11);
        ArrayList<Match> weekElevenMatches = weekEleven.getMatches();
        Week weekTwelve = mModel.getSeasonSchedule().getWeek(12);
        ArrayList<Match> weekTwelveMatches = weekTwelve.getMatches();
        Week weekThirteen = mModel.getSeasonSchedule().getWeek(13);
        ArrayList<Match> weekThirteenMatches = weekThirteen.getMatches();
        Week weekFourteen = mModel.getSeasonSchedule().getWeek(14);
        ArrayList<Match> weekFourteenMatches = weekFourteen.getMatches();
        Week weekFifteen = mModel.getSeasonSchedule().getWeek(15);
        ArrayList<Match> weekFifteenMatches = weekFifteen.getMatches();
        Week weekSixteen = mModel.getSeasonSchedule().getWeek(16);
        ArrayList<Match> weekSixteenMatches = weekSixteen.getMatches();
        Week weekSeventeen = mModel.getSeasonSchedule().getWeek(17);
        ArrayList<Match> weekSeventeenMatches = weekSeventeen.getMatches();
        Week wildCard = mModel.getSeasonSchedule().getWeek(18);
        ArrayList<Match> wildcardMatches = wildCard.getMatches();
        ...
        if (!weekElevenMatches.get(0).getComplete()) {
            weekElevenMatches.get(0).complete(24, 27);
        }
        if (!weekElevenMatches.get(1).getComplete()) {
            weekElevenMatches.get(1).complete(10, 38);
        }
        if (!weekElevenMatches.get(2).getComplete()) {
            weekElevenMatches.get(2).complete(35, 38);
        }
        if (!weekElevenMatches.get(3).getComplete()) {
            weekElevenMatches.get(3).complete(20, 25);
        }
        if (!weekElevenMatches.get(4).getComplete()) {
            weekElevenMatches.get(4).complete(7, 48);
        }
        if (!weekElevenMatches.get(5).getComplete()) {
            weekElevenMatches.get(5).complete(19, 20);
        }
        if (!weekElevenMatches.get(6).getComplete()) {
            weekElevenMatches.get(6).complete(22, 19);
        }
        if (!weekElevenMatches.get(7).getComplete()) {
            weekElevenMatches.get(7).complete(21, 24);
        }
        if (!weekElevenMatches.get(8).getComplete()) {
            weekElevenMatches.get(8).complete(23, 21);
        }
        if (!weekElevenMatches.get(9).getComplete()) {
            weekElevenMatches.get(9).complete(23, 21);
        }
        if (!weekElevenMatches.get(10).getComplete()) {
            weekElevenMatches.get(10).complete(23, 22);
        }
        if (!weekElevenMatches.get(11).getComplete()) {
            weekElevenMatches.get(11).complete(20, 16);
        }
        if (!weekElevenMatches.get(12).getComplete()) {
            weekElevenMatches.get(12).complete(51, 54);
        }
        if (!weekTwelveMatches.get(0).getComplete()) {
            weekTwelveMatches.get(0).complete(23, 16);
        }
        if (!weekTwelveMatches.get(1).getComplete()) {
            weekTwelveMatches.get(1).complete(23, 31);
        }
        if (!weekTwelveMatches.get(2).getComplete()) {
            weekTwelveMatches.get(2).complete(17, 31);
        }
        if (!weekTwelveMatches.get(3).getComplete()) {
            weekTwelveMatches.get(3).complete(22, 25);
        }
        if (!weekTwelveMatches.get(4).getComplete()) {
            weekTwelveMatches.get(4).complete(21, 24);
        }
        if (!weekTwelveMatches.get(5).getComplete()) {
            weekTwelveMatches.get(5).complete(30, 27);
        }
        if (!weekTwelveMatches.get(6).getComplete()) {
            weekTwelveMatches.get(6).complete(17, 34);
        }
        if (!weekTwelveMatches.get(7).getComplete()) {
            weekTwelveMatches.get(7).complete(9, 27);
        }
        if (!weekTwelveMatches.get(8).getComplete()) {
            weekTwelveMatches.get(8).complete(24, 27);
        }
        if (!weekTwelveMatches.get(9).getComplete()) {
            weekTwelveMatches.get(9).complete(35, 20);
        }
        if (!weekTwelveMatches.get(10).getComplete()) {
            weekTwelveMatches.get(10).complete(27, 13);
        }
        if (!weekTwelveMatches.get(11).getComplete()) {
            weekTwelveMatches.get(11).complete(10, 45);
        }
        if (!weekTwelveMatches.get(12).getComplete()) {
            weekTwelveMatches.get(12).complete(17, 24);
        }
        if (!weekTwelveMatches.get(13).getComplete()) {
            weekTwelveMatches.get(13).complete(17, 24);
        }
        if (!weekTwelveMatches.get(14).getComplete()) {
            weekTwelveMatches.get(14).complete(17, 34);
        }
        if (!weekThirteenMatches.get(0).getComplete()) {
            weekThirteenMatches.get(0).complete(10, 13);
        }
        if (!weekThirteenMatches.get(1).getComplete()) {
            weekThirteenMatches.get(1).complete(27, 30);
        }
        if (!weekThirteenMatches.get(2).getComplete()) {
            weekThirteenMatches.get(2).complete(20, 17);
        }
        if (!weekThirteenMatches.get(3).getComplete()) {
            weekThirteenMatches.get(3).complete(0, 6);
        }
        if (!weekThirteenMatches.get(4).getComplete()) {
            weekThirteenMatches.get(4).complete(13, 29);
        }
        if (!weekThirteenMatches.get(5).getComplete()) {
            weekThirteenMatches.get(5).complete(17, 24);
        }
        if (!weekThirteenMatches.get(6).getComplete()) {
            weekThirteenMatches.get(6).complete(17, 21);
        }
        if (!weekThirteenMatches.get(7).getComplete()) {
            weekThirteenMatches.get(7).complete(24, 10);
        }
        if (!weekThirteenMatches.get(8).getComplete()) {
            weekThirteenMatches.get(8).complete(26, 16);
        }
        if (!weekThirteenMatches.get(9).getComplete()) {
            weekThirteenMatches.get(9).complete(33, 30);
        }
        if (!weekThirteenMatches.get(10).getComplete()) {
            weekThirteenMatches.get(10).complete(30, 16);
        }
        if (!weekThirteenMatches.get(11).getComplete()) {
            weekThirteenMatches.get(11).complete(40, 33);
        }
        if (!weekThirteenMatches.get(12).getComplete()) {
            weekThirteenMatches.get(12).complete(22, 26);
        }
        if (!weekThirteenMatches.get(13).getComplete()) {
            weekThirteenMatches.get(13).complete(10, 24);
        }
        if (!weekThirteenMatches.get(14).getComplete()) {
            weekThirteenMatches.get(14).complete(16, 43);
        }
        if (!weekThirteenMatches.get(15).getComplete()) {
            weekThirteenMatches.get(15).complete(13, 28);
        }
        if (!weekFourteenMatches.get(0).getComplete()) {
            weekFourteenMatches.get(0).complete(9, 30);
        }
        if (!weekFourteenMatches.get(1).getComplete()) {
            weekFourteenMatches.get(1).complete(20, 26);
        }
        if (!weekFourteenMatches.get(2).getComplete()) {
            weekFourteenMatches.get(2).complete(6, 15);
        }
        if (!weekFourteenMatches.get(3).getComplete()) {
            weekFourteenMatches.get(3).complete(24, 27);
        }
        if (!weekFourteenMatches.get(4).getComplete()) {
            weekFourteenMatches.get(4).complete(24, 21);
        }
        if (!weekFourteenMatches.get(5).getComplete()) {
            weekFourteenMatches.get(5).complete(33, 34);
        }
        if (!weekFourteenMatches.get(6).getComplete()) {
            weekFourteenMatches.get(6).complete(40, 16);
        }
        if (!weekFourteenMatches.get(7).getComplete()) {
            weekFourteenMatches.get(7).complete(28, 14);
        }
        if (!weekFourteenMatches.get(8).getComplete()) {
            weekFourteenMatches.get(8).complete(20, 34);
        }
        if (!weekFourteenMatches.get(9).getComplete()) {
            weekFourteenMatches.get(9).complete(27, 23);
        }
        if (!weekFourteenMatches.get(10).getComplete()) {
            weekFourteenMatches.get(10).complete(21, 26);
        }
        if (!weekFourteenMatches.get(11).getComplete()) {
            weekFourteenMatches.get(11).complete(14, 20);
        }
        if (!weekFourteenMatches.get(12).getComplete()) {
            weekFourteenMatches.get(12).complete(23, 29);
        }
        if (!weekFourteenMatches.get(13).getComplete()) {
            weekFourteenMatches.get(13).complete(17, 3);
        }
        if (!weekFourteenMatches.get(14).getComplete()) {
            weekFourteenMatches.get(14).complete(21, 24);
        }
        if (!weekFourteenMatches.get(15).getComplete()) {
            weekFourteenMatches.get(15).complete(7, 21);
        }
        if (!weekFifteenMatches.get(0).getComplete()) {
            weekFifteenMatches.get(0).complete(29, 28);
        }
        if (!weekFifteenMatches.get(1).getComplete()) {
            weekFifteenMatches.get(1).complete(29, 22);
        }
        if (!weekFifteenMatches.get(2).getComplete()) {
            weekFifteenMatches.get(2).complete(17, 16);
        }
        if (!weekFifteenMatches.get(3).getComplete()) {
            weekFifteenMatches.get(3).complete(14, 40);
        }
        if (!weekFifteenMatches.get(4).getComplete()) {
            weekFifteenMatches.get(4).complete(16, 30);
        }
        if (!weekFifteenMatches.get(5).getComplete()) {
            weekFifteenMatches.get(5).complete(17, 41);
        }
        if (!weekFifteenMatches.get(6).getComplete()) {
            weekFifteenMatches.get(6).complete(0, 23);
        }
        if (!weekFifteenMatches.get(7).getComplete()) {
            weekFifteenMatches.get(7).complete(12, 20);
        }
        if (!weekFifteenMatches.get(8).getComplete()) {
            weekFifteenMatches.get(8).complete(13, 14);
        }
        if (!weekFifteenMatches.get(9).getComplete()) {
            weekFifteenMatches.get(9).complete(17, 24);
        }
        if (!weekFifteenMatches.get(10).getComplete()) {
            weekFifteenMatches.get(10).complete(16, 13);
        }
        if (!weekFifteenMatches.get(11).getComplete()) {
            weekFifteenMatches.get(11).complete(17, 0);
        }
        if (!weekFifteenMatches.get(12).getComplete()) {
            weekFifteenMatches.get(12).complete(23, 26);
        }
        if (!weekFifteenMatches.get(13).getComplete()) {
            weekFifteenMatches.get(13).complete(10, 17);
        }
        if (!weekFifteenMatches.get(14).getComplete()) {
            weekFifteenMatches.get(14).complete(30, 23);
        }
        if (!weekFifteenMatches.get(15).getComplete()) {
            weekFifteenMatches.get(15).complete(12, 9);
        }
        if (!weekSixteenMatches.get(0).getComplete()) {
            weekSixteenMatches.get(0).complete(22, 10);
        }
        if (!weekSixteenMatches.get(1).getComplete()) {
            weekSixteenMatches.get(1).complete(27, 28);
        }
        if (!weekSixteenMatches.get(2).getComplete()) {
            weekSixteenMatches.get(2).complete(17, 7);
        }
        if (!weekSixteenMatches.get(3).getComplete()) {
            weekSixteenMatches.get(3).complete(16, 25);
        }
        if (!weekSixteenMatches.get(4).getComplete()) {
            weekSixteenMatches.get(4).complete(20, 27);
        }
        if (!weekSixteenMatches.get(5).getComplete()) {
            weekSixteenMatches.get(5).complete(27, 9);
        }
        if (!weekSixteenMatches.get(6).getComplete()) {
            weekSixteenMatches.get(6).complete(24, 10);
        }
        if (!weekSixteenMatches.get(7).getComplete()) {
            weekSixteenMatches.get(7).complete(30, 32);
        }
        if (!weekSixteenMatches.get(8).getComplete()) {
            weekSixteenMatches.get(8).complete(18, 26);
        }
        if (!weekSixteenMatches.get(9).getComplete()) {
            weekSixteenMatches.get(9).complete(12, 24);
        }
        if (!weekSixteenMatches.get(10).getComplete()) {
            weekSixteenMatches.get(10).complete(44, 38);
        }
        if (!weekSixteenMatches.get(11).getComplete()) {
            weekSixteenMatches.get(11).complete(14, 9);
        }
        if (!weekSixteenMatches.get(12).getComplete()) {
            weekSixteenMatches.get(12).complete(31, 9);
        }
        if (!weekSixteenMatches.get(13).getComplete()) {
            weekSixteenMatches.get(13).complete(28, 31);
        }
        if (!weekSixteenMatches.get(14).getComplete()) {
            weekSixteenMatches.get(14).complete(31, 38);
        }
        if (!weekSixteenMatches.get(15).getComplete()) {
            weekSixteenMatches.get(15).complete(14, 27);
        }
        if (!weekSeventeenMatches.get(0).getComplete()) {
            weekSeventeenMatches.get(0).complete(3, 35);
        }
        if (!weekSeventeenMatches.get(1).getComplete()) {
            weekSeventeenMatches.get(1).complete(17, 42);
        }
        if (!weekSeventeenMatches.get(2).getComplete()) {
            weekSeventeenMatches.get(2).complete(33, 17);
        }
        if (!weekSeventeenMatches.get(3).getComplete()) {
            weekSeventeenMatches.get(3).complete(24, 26);
        }
        if (!weekSeventeenMatches.get(4).getComplete()) {
            weekSeventeenMatches.get(4).complete(31, 0);
        }
        if (!weekSeventeenMatches.get(5).getComplete()) {
            weekSeventeenMatches.get(5).complete(3, 38);
        }
        if (!weekSeventeenMatches.get(6).getComplete()) {
            weekSeventeenMatches.get(6).complete(24, 10);
        }
        if (!weekSeventeenMatches.get(7).getComplete()) {
            weekSeventeenMatches.get(7).complete(33, 14);
        }
        if (!weekSeventeenMatches.get(8).getComplete()) {
            weekSeventeenMatches.get(8).complete(3, 20);
        }
        if (!weekSeventeenMatches.get(9).getComplete()) {
            weekSeventeenMatches.get(9).complete(36, 35);
        }
        if (!weekSeventeenMatches.get(10).getComplete()) {
            weekSeventeenMatches.get(10).complete(24, 0);
        }
        if (!weekSeventeenMatches.get(11).getComplete()) {
            weekSeventeenMatches.get(11).complete(34, 32);
        }
        if (!weekSeventeenMatches.get(12).getComplete()) {
            weekSeventeenMatches.get(12).complete(13, 16);
        }
        if (!weekSeventeenMatches.get(13).getComplete()) {
            weekSeventeenMatches.get(13).complete(24, 27);
        }
        if (!weekSeventeenMatches.get(14).getComplete()) {
            weekSeventeenMatches.get(14).complete(32, 48);
        }
        if (!weekSeventeenMatches.get(15).getComplete()) {
            weekSeventeenMatches.get(15).complete(23, 9);
        }
        if (!wildcardMatches.get(0).getComplete()) {
            wildcardMatches.get(0).complete(23, 9);
        }
    ...
    public void loadCurrentSeasonPlayoffOdds() {
        ...
        currentSeasonTeams.get(NFLConstants.TEAM_HOUSTON_TEXANS_STRING).setPlayoffOddsString("100-100-6-3");
        currentSeasonTeams.get(NFLConstants.TEAM_MINNESOTA_VIKINGS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_OAKLAND_RAIDERS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_LOSANGELES_RAMS_STRING).setPlayoffOddsString("100-100-25-12");
        currentSeasonTeams.get(NFLConstants.TEAM_PHILADELPHIA_EAGLES_STRING).setPlayoffOddsString("100-0-4.54-2.28");
        currentSeasonTeams.get(NFLConstants.TEAM_ARIZONA_CARDINALS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_NEWYORK_GIANTS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_WASHINGTON_REDSKINS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_ATLANTA_FALCONS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_BUFFALO_BILLS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_KANSASCITY_CHIEFS_STRING).setPlayoffOddsString("100-100-38-18");
        currentSeasonTeams.get(NFLConstants.TEAM_NEWORLEANS_SAINTS_STRING).setPlayoffOddsString("100-100-40-23");
        currentSeasonTeams.get(NFLConstants.TEAM_JACKSONVILLE_JAGUARS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_BALTIMORE_RAVENS_STRING).setPlayoffOddsString("100-100-10-4");
        currentSeasonTeams.get(NFLConstants.TEAM_DALLAS_COWBOYS_STRING).setPlayoffOddsString("100-100-3-1");
        currentSeasonTeams.get(NFLConstants.TEAM_CINCINNATI_BENGALS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_GREENBAY_PACKERS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_NEWYORK_JETS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_SEATTLE_SEAHAWKS_STRING).setPlayoffOddsString("100-0-6-1.5");
        currentSeasonTeams.get(NFLConstants.TEAM_PITTSBURGH_STEELERS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_DENVER_BRONCOS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_LOSANGELES_CHARGERS_STRING).setPlayoffOddsString("100-0-9-4");
        currentSeasonTeams.get(NFLConstants.TEAM_CAROLINA_PANTHERS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_NEWENGLAND_PATRIOTS_STRING).setPlayoffOddsString("100-100-34-18");
        currentSeasonTeams.get(NFLConstants.TEAM_INDIANAPOLIS_COLTS_STRING).setPlayoffOddsString("100-0-1-0.5");
        currentSeasonTeams.get(NFLConstants.TEAM_MIAMI_DOLPHINS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_CLEVELAND_BROWNS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_CHICAGO_BEARS_STRING).setPlayoffOddsString("100-100-5-3");
        currentSeasonTeams.get(NFLConstants.TEAM_TENNESSEE_TITANS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_DETROIT_LIONS_STRING).setPlayoffOddsString("0-0-0-0");
        currentSeasonTeams.get(NFLConstants.TEAM_TAMPABAY_BUCCANEERS_STRING).setPlayoffOddsString("0-0-0-0");
    }
    ...
    private void updateSimulatorCompletedGameScores() {
        ...
        ArrayList<Match> weekTenMatches = weekTen.getMatches();
        Week weekEleven = mModel.getSimulatorSchedule().getWeek(11);
        ArrayList<Match> weekElevenMatches = weekEleven.getMatches();
        Week weekTwelve = mModel.getSimulatorSchedule().getWeek(12);
        ArrayList<Match> weekTwelveMatches = weekTwelve.getMatches();
        Week weekThirteen = mModel.getSimulatorSchedule().getWeek(13);
        ArrayList<Match> weekThirteenMatches = weekThirteen.getMatches();
        Week weekFourteen = mModel.getSimulatorSchedule().getWeek(14);
        ArrayList<Match> weekFourteenMatches = weekFourteen.getMatches();
        Week weekFifteen = mModel.getSimulatorSchedule().getWeek(15);
        ArrayList<Match> weekFifteenMatches = weekFifteen.getMatches();
        Week weekSixteen = mModel.getSimulatorSchedule().getWeek(16);
        ArrayList<Match> weekSixteenMatches = weekSixteen.getMatches();
        Week weekSeventeen = mModel.getSimulatorSchedule().getWeek(17);
        ArrayList<Match> weekSeventeenMatches = weekSeventeen.getMatches();
        weekOneMatches.get(0).complete(12, 18);
        weekOneMatches.get(1).complete(34, 23);
        weekOneMatches.get(2).complete(3, 47);
    ...
    private void updateCurrentSeasonTeamOdds() {
        ...
        Week weekTwelve = currentSchedule.getWeek(12);
        ArrayList<Match> weekTwelveMatches = weekTwelve.getMatches();
        weekTwelveMatches.get(0).setOdds(-4.0);
        weekTwelveMatches.get(1).setOdds(7.5);
        weekTwelveMatches.get(2).setOdds(13.0);
        weekTwelveMatches.get(3).setOdds(6.0);
        weekTwelveMatches.get(4).setOdds(-3.0);
        weekTwelveMatches.get(5).setOdds(3.5);
        weekTwelveMatches.get(6).setOdds(11.0);
        weekTwelveMatches.get(7).setOdds(3.5);
        weekTwelveMatches.get(8).setOdds(9.5);
        weekTwelveMatches.get(9).setOdds(3.0);
        weekTwelveMatches.get(10).setOdds(-9.5);
        weekTwelveMatches.get(11).setOdds(12.0);
        weekTwelveMatches.get(12).setOdds(3.0);
        weekTwelveMatches.get(13).setOdds(3.5);
        weekTwelveMatches.get(14).setOdds(0.0);
        Week weekThirteen = currentSchedule.getWeek(13);
        ArrayList<Match> weekThirteenMatches = weekThirteen.getMatches();
        weekThirteenMatches.get(0).setOdds(-7.0);
        weekThirteenMatches.get(1).setOdds(0.0);
        weekThirteenMatches.get(2).setOdds(14.0);
        weekThirteenMatches.get(3).setOdds(-3.5);
        weekThirteenMatches.get(4).setOdds(4.5);
        weekThirteenMatches.get(5).setOdds(-4.0);
        weekThirteenMatches.get(6).setOdds(6.0);
        weekThirteenMatches.get(7).setOdds(0.0);
        weekThirteenMatches.get(8).setOdds(-3.0);
        weekThirteenMatches.get(9).setOdds(3.5);
        weekThirteenMatches.get(10).setOdds(-9.5);
        weekThirteenMatches.get(11).setOdds(-15.5);
        weekThirteenMatches.get(12).setOdds(9.5);
        weekThirteenMatches.get(13).setOdds(7.0);
        weekThirteenMatches.get(14).setOdds(10.0);
        weekThirteenMatches.get(15).setOdds(7.0);
        Week weekFourteen = currentSchedule.getWeek(14);
        ArrayList<Match> weekFourteenMatches = weekFourteen.getMatches();
        weekFourteenMatches.get(0).setOdds(4.0);
        weekFourteenMatches.get(1).setOdds(-1.5);
        weekFourteenMatches.get(2).setOdds(-3.0);
        weekFourteenMatches.get(3).setOdds(6.5);
        weekFourteenMatches.get(4).setOdds(4.5);
        weekFourteenMatches.get(5).setOdds(-8.0);
        weekFourteenMatches.get(6).setOdds(1.5);
        weekFourteenMatches.get(7).setOdds(-8.0);
        weekFourteenMatches.get(8).setOdds(5.5);
        weekFourteenMatches.get(9).setOdds(3.5);
        weekFourteenMatches.get(10).setOdds(14.0);
        weekFourteenMatches.get(11).setOdds(-5.5);
        weekFourteenMatches.get(12).setOdds(4.5);
        weekFourteenMatches.get(13).setOdds(-2.5);
        weekFourteenMatches.get(14).setOdds(-11.0);
        weekFourteenMatches.get(15).setOdds(3.5);
        Week weekFifteen = currentSchedule.getWeek(15);
        ArrayList<Match> weekFifteenMatches = weekFifteen.getMatches();
        weekFifteenMatches.get(0).setOdds(3.5);
        weekFifteenMatches.get(1).setOdds(-6.5);
        weekFifteenMatches.get(2).setOdds(3.5);
        weekFifteenMatches.get(3).setOdds(0.0);
        weekFifteenMatches.get(4).setOdds(3.5);
        weekFifteenMatches.get(5).setOdds(8.0);
        weekFifteenMatches.get(6).setOdds(0.0);
        weekFifteenMatches.get(7).setOdds(8.0);
        weekFifteenMatches.get(8).setOdds(1.5);
        weekFifteenMatches.get(9).setOdds(5.5);
        weekFifteenMatches.get(10).setOdds(7.0);
        weekFifteenMatches.get(11).setOdds(2.5);
        weekFifteenMatches.get(12).setOdds(0.0);
        weekFifteenMatches.get(13).setOdds(0.0);
        weekFifteenMatches.get(14).setOdds(8.5);
        weekFifteenMatches.get(15).setOdds(-6.5);
        Week weekSixteen = currentSchedule.getWeek(16);
        ArrayList<Match> weekSixteenMatches = weekSixteen.getMatches();
        weekSixteenMatches.get(0).setOdds(4.5);
        weekSixteenMatches.get(1).setOdds(9.5);
        weekSixteenMatches.get(2).setOdds(4.5);
        weekSixteenMatches.get(3).setOdds(10.0);
        weekSixteenMatches.get(4).setOdds(0.0);
        weekSixteenMatches.get(5).setOdds(-4.5);
        weekSixteenMatches.get(6).setOdds(3.5);
        weekSixteenMatches.get(7).setOdds(0.0);
        weekSixteenMatches.get(8).setOdds(7.0);
        weekSixteenMatches.get(9).setOdds(12.0);
        weekSixteenMatches.get(10).setOdds(-2.5);
        weekSixteenMatches.get(11).setOdds(-3.5);
        weekSixteenMatches.get(12).setOdds(-7.0);
        weekSixteenMatches.get(13).setOdds(6.5);
        weekSixteenMatches.get(14).setOdds(-2.5);
        weekSixteenMatches.get(15).setOdds(-2.5);
        Week weekSeventeen = currentSchedule.getWeek(17);
        ArrayList<Match> weekSeventeenMatches = weekSeventeen.getMatches();
        weekSeventeenMatches.get(0).setOdds(9.0);
        weekSeventeenMatches.get(1).setOdds(3.0);
        weekSeventeenMatches.get(2).setOdds(0.0);
        weekSeventeenMatches.get(3).setOdds(5.5);
        weekSeventeenMatches.get(4).setOdds(7.0);
        weekSeventeenMatches.get(5).setOdds(13.5);
        weekSeventeenMatches.get(6).setOdds(5.0);
        weekSeventeenMatches.get(7).setOdds(0.0);
        weekSeventeenMatches.get(8).setOdds(7.0);
        weekSeventeenMatches.get(9).setOdds(0.0);
        weekSeventeenMatches.get(10).setOdds(-6.5);
        weekSeventeenMatches.get(11).setOdds(0.0);
        weekSeventeenMatches.get(12).setOdds(14.0);
        weekSeventeenMatches.get(13).setOdds(5.0);
        weekSeventeenMatches.get(14).setOdds(10.0);
        weekSeventeenMatches.get(15).setOdds(0.0);
    ...
    private ArrayList<ArrayList<Team>> generateSimulatorPlayoffTeams(int seasonType) {
        ...
        HashMap<String, Team> allTeamsHashMap;

        //Get all NFL teams
        //The arraylist is used for simulating and generating playoff seeds
        //The hashmap is used to manually set the playoff seeds when they are known.
        if (seasonType == SimulatorPresenter.SEASON_TYPE_SIMULATOR) {
            allTeams = mModel.getSimulatorTeamArrayList();
            allTeamsHashMap = mModel.getSimulatorTeamList();
        } else {
            allTeams = mModel.getSeasonTeamArrayList();
            allTeamsHashMap = mModel.getSeasonTeamList();
        }



        //THE BELOW CODE IS USED IF YOU ARE AUTOMATICALLY DETERMINING WHICH TEAMS SHOULD BE PLAYOFF TEAMS
        /*
...
*/
        //The BELOW CODE IS USED IF YOU ARE MANUALLY DETERMINING WHICH TEAMS SHOULD BE PLAYOFF TEAMS
        Team baltimore = allTeamsHashMap.get(NFLConstants.TEAM_BALTIMORE_RAVENS_STRING);
        afcNorthDivLeader = baltimore;

        Team houston = allTeamsHashMap.get(NFLConstants.TEAM_HOUSTON_TEXANS_STRING);
        Team indy = allTeamsHashMap.get(NFLConstants.TEAM_INDIANAPOLIS_COLTS_STRING);
        afcSouthDivLeader = houston;

        Team kc = allTeamsHashMap.get(NFLConstants.TEAM_KANSASCITY_CHIEFS_STRING);
        Team lac = allTeamsHashMap.get(NFLConstants.TEAM_LOSANGELES_CHARGERS_STRING);
            afcWestDivLeader = kc;


        afcEastDivLeader = allTeamsHashMap.get(NFLConstants.TEAM_NEWENGLAND_PATRIOTS_STRING);
        nfcNorthDivLeader = allTeamsHashMap.get(NFLConstants.TEAM_CHICAGO_BEARS_STRING);
        nfcSouthDivLeader = allTeamsHashMap.get(NFLConstants.TEAM_NEWORLEANS_SAINTS_STRING);
        nfcWestDivLeader = allTeamsHashMap.get(NFLConstants.TEAM_LOSANGELES_RAMS_STRING);
        nfcEastDivLeader = allTeamsHashMap.get(NFLConstants.TEAM_DALLAS_COWBOYS_STRING);

            afcPotentialWildCardTeams.add(indy);

        afcPotentialWildCardTeams.add(lac);

        Team phi = allTeamsHashMap.get(NFLConstants.TEAM_PHILADELPHIA_EAGLES_STRING);

        nfcPotentialWildCardTeams.add(allTeamsHashMap.get(NFLConstants.TEAM_SEATTLE_SEAHAWKS_STRING));
            nfcPotentialWildCardTeams.add(phi);
        ...
        ArrayList<ArrayList<Team>> allPlayoffTeams =
                Standings.generateTestPlayoffTeams(afcDivisonWinners, nfcDivisionWinners, afcPotentialWildCardTeams, nfcPotentialWildCardTeams, allTeamsHashMap);
